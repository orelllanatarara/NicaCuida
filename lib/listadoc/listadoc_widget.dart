...
import 'listadoc_model.dart';
export 'listadoc_model.dart';

class ListadocWidget extends StatefulWidget {
  const ListadocWidget({super.key});

  @override
  State<ListadocWidget> createState() => _ListadocWidgetState();
}

class _ListadocWidgetState extends State<ListadocWidget>
    with TickerProviderStateMixin {
  late ListadocModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListadocModel());
