...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const InicioWidget() : const GenesisWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'datosdehistorialclinico',
          path: '/datosdehistorialclinico',
          builder: (context, params) => const DatosdehistorialclinicoWidget(),
        ),
        FFRoute(
          name: 'page6',
          path: '/page6',
        ...
        FFRoute(
          name: 'Genesis',
          path: '/genesis',
          builder: (context, params) => const GenesisWidget(),
        ),
        FFRoute(
          name: 'listadoc',
          path: '/listadoc',
